...
import { useResetPasswordAdminsMutation } from "@/redux/apis/reset_password/resetPasswordAdminsApi";

const ResetPasswordFormAdmins: React.FC = () => {
  ...
  ] = useResetPasswordAdminsMutation({
    fixedCacheKey: "resetPasswordAdminsData",
  });
  ...
  const handleResetPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    try {
      ...
      if (token && newPasswordResetLocalState) {
        const response: any = await resetPasswordAdmins({
          token: token,
    ...
    >
      ...
      >
        ...
        {resetPasswordIsSuccess ? (
          ...
          <Form
            id="reset-password-form-admins"
            name="reset-password-form-admins"
            className="reset-password-form-admins"
          ...
          >
            <h2
              className="title-reset-password-admins"
              style={{
                ...titleStyleCss,
                marginBlock: 22,
                textAlign: "center",
            ...
            <Form.Item
              id="new-reset-password-admins"
              name="new-reset-password-admins"
              className="new-reset-password-admins"
            ...
            <Form.Item
              id="verify-new-reset-password-admins"
              name="verify-new-reset-password-admins"
              className="verify-new-reset-password-admins"
              label="Verificar contraseña nueva"
              style={{ marginBottom: 22 }}
              dependencies={["new-reset-password-admins"]}
              rules={[
                {
                  required: true,
                ...
                ({ getFieldValue }) => ({
                  validator(_, value) {
                    if (
                      !value ||
                      getFieldValue("new-reset-password-admins") === value
                    ) {
                      return Promise.resolve();
                    }
            ...
            >
              {isSubmittingChangePassword ? (
                ...
                <Button
                  ...
                  htmlType="submit"
                  className="reset-password-form-button-admins"
...
export default ResetPasswordFormAdmins;
