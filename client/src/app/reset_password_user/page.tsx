...
import ResetPasswordFormUsers from "@/components/reset_password/ResetPasswordFormUsers";

import { setPasswordResetToken } from "@/redux/features/common/modal/modalSlice";

const ResetPasswordUsersPage: React.FC = () => {
...
export default ResetPasswordUsersPage;
